...
class CardService extends BaseService {
	...
	async getCardList({
		...
		let fields = 'CARD_PIC,CARD_VIEW_CNT,CARD_NAME,CARD_DESC,CARD_TYPE,CARD_PRICE,CARD_TIMES,CARD_AMOUNT,CARD_VALIDITY_DAYS,CARD_ADD_TIME,CARD_ORDER,CARD_STATUS,CARD_HOME,CARD_PAYMENT_ZELLE,CARD_PAYMENT_QR,CARD_PAYMENT_INSTRUCTIONS';
	...
	async getHomeCardList() {
		...
		let fields = 'CARD_PIC,CARD_NAME,CARD_DESC,CARD_TYPE,CARD_PRICE,CARD_TIMES,CARD_AMOUNT,CARD_VALIDITY_DAYS,CARD_ADD_TIME,CARD_HOME,CARD_PAYMENT_ZELLE,CARD_PAYMENT_QR,CARD_PAYMENT_INSTRUCTIONS';
