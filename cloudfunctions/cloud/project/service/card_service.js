...
class CardService extends BaseService {
	...
	async getCardList({
		...
		let fields = 'CARD_PIC,CARD_VIEW_CNT,CARD_NAME,CARD_DESC,CARD_TYPE,CARD_PRICE,CARD_TIMES,CARD_AMOUNT,CARD_VALIDITY_DAYS,CARD_ADD_TIME,CARD_ORDER,CARD_STATUS';
	...
	async getHomeCardList() {
		...
		let fields = 'CARD_PIC,CARD_NAME,CARD_DESC,CARD_TYPE,CARD_PRICE,CARD_TIMES,CARD_AMOUNT,CARD_VALIDITY_DAYS,CARD_ADD_TIME';
