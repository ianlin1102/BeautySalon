module.exports = {
	...
	//### 环境相关 
	CLOUD_ID: 'cloud1-6gnd02he13c1ff2e', //你的云环境id 
	...
	COLLECTION_NAME: 'ax_admin|ax_cache|ax_card_item|ax_card_record|ax_day|ax_export|ax_join|ax_log|ax_meet|ax_news|ax_setup|ax_temp|ax_user|ax_user_card',
